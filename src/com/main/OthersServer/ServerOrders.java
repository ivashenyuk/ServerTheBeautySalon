...
import com.main.MyData.DataOrderLine;
...
public class ServerOrders implements TCPConnectionListener {
    ...
    public ServerOrders() {
        ...
        listProfit = dataBase.GetOrder();
        System.out.println("\tServerOrders is running...");
        thread = new Thread(new Runnable() {
            @Override
            public void run() {
                try (ServerSocket serverSocket = new ServerSocket(Setting.getPortGetOrders())) {
                    System.out.println("\t" +serverSocket.getLocalSocketAddress());
                    while (true) {
                        new TCPConnection(ServerOrders.this, serverSocket.accept());
                    }
